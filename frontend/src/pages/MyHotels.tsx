    ...
    return (
        <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 gap-8">
                {hotelData.map((hotel)=>(
                    <div className="flex flex-col justify-beetween border border-slate-300 rounded-lg p-8 gap-5 " >
                        <h2 className="text-2xl font-bold">{hotel.name}</h2>
                        <div className="whitespaces-pre-line" >{hotel.description}</div>
                        <div className="grid grid-cols-5 gap-2">
                            <div className="boarder boarder-slate-300 rounded-sm p-3 items-center">
